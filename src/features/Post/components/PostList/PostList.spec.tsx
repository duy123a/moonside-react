...
describe('PostList', () => {
  it('renders a list with 3 posts', () => {
    const mockData = [
      {
        id: 'lea2aa9l7x3a5tg',
  ...
  it('renders a list with 0 posts', () => {
    render(
      <BrowserRouter>
        <SnackbarProvider>
          <PostList></PostList>
    ...
    // If you want to receive null array insead of an exception, use query instead of get
    const postList = screen.queryAllByLabelText('postCard');
